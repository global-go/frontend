<template>
  <div class="wrapper">
    ...
    <div class="content">
      <div class="box">
        <div class="text">订单序号：{{item.orderID}}</div>
        <div class="text">用户账号：{{this.userInfo.nickname}}</div>
        <div class="text">订单成交时间：<br>{{item.time}}</div>
      </div>
      <div class="box">
        <div class="text">配送地址：{{item.address}}</div>
        <div class="text">收件人：{{item.addressee}}</div>
